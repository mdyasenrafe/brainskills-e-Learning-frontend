...
const Course2 = () => {
    return (
        <div>
            ...
            <h1>Tickets cards</h1>
            <ul>
                <li class="booking-card" style={{backgroundImage:"url(https://i.ibb.co/n325rt5/images-2.jpg)"}}>
                    ...
                    <div class="informations-container">
                        <h2 class="title">Digital Markating</h2>
            ...
            {/* <p class="credits">Designed by <a href="https://www.linkedin.com/in/ana%C3%AFs-laghzali-8b613297/" target="_blank">Anaïs Laghzali</a> & developed by <a href="https://remiruc.com" target="_blank">Rémi Rucojevic</a>
            <br>at <a href="https://www.hippocampe.fr" target="_blank">Hippocampe.fr</a></p> */}
        </div>
    );
};
