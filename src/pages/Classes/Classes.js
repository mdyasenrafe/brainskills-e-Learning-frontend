      ...
      <div className="bg-white">
            ...
            <div className="w-full h-fit lg:w-8/12 overflow-hidden rounded-md ">
              ...
              <div className="pb-4 pt-14 px-2 flex justify-between items-center">
                ...
                <div className="space-x-4">
                  <button
                    onClick={() => videoChangeHandler("decrease")}
                    className="py-2 px-6 md:px-10 border-blue-600 border-2 rounded-full hover:bg-blue-600 hover:text-white ease-out duration-300"
                  >
                    Previous
                  </button>
                  <button
                    onClick={() => videoChangeHandler("increase")}
                    className="py-2 px-6 md:px-10 border-blue-600 border-2 rounded-full bg-blue-600 text-white"
                  >
                    Next
                  </button>
                </div>
              ...
              <div className="px-4 pb-5">
                <h4 className="text-red-500 flex items-center">
            ...
            <div className="lg:w-4/12">
              <div>
                <div className="py-3 mb-4 px-4 bg-blue-400 border rounded-t-md ">
                  <input
                    className="py-2 w-full outline-none rounded-sm bg-gray-50 px-3"
                    type="text "
                  ...
                  {course.map((item, index) => (
                    <div key={item?.id}>
                      <button
                        ...
                        className="w-full text-left p-2 py-3 mb-2 shadow-sm rounded-lg font-semibold bg-white border border-blue-100 text-gray-800 hover:shadow-md hover:border-emerald-400 ease-in-out duration-300 "
                      >
                        {item?.name}
                      </button>
                    </div>
        ...
        <div className="pb-4 pt-14 px-2 flex justify-between items-center">
          ...
          <div className="space-x-4 flex items-center">
            ...
            <button className="py-2 px-6 md:px-10 border-blue-600 border-2 rounded-full bg-blue-600 text-white">
              Next
            </button>
          </div>
        </div>
      ...
      <div className="lg:w-4/12">
        <div>
          ...
          <div className="course-content-list rounded-lg ">
            {qna.map((item) => (
              <div key={item?.id}>
                <button className="w-full text-left p-2 py-3 mb-2 shadow-sm rounded-lg font-semibold bg-white border border-blue-100 text-gray-800 hover:shadow-md hover:border-emerald-400 ease-in-out duration-300 ">
                  {item.name}
                </button>
              </div>
            ))}
