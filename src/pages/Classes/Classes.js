...
const Classes = ({ classes }) => {
  ...
  return (
    <div data-testId="classes" className="bg-white pb-10">
              ...
              {!question && (
                <div>
                  ...
                  <div className="absolute right-0 -bottom-9  py-2 px-5 bg-indigo-900 w-full text-white">
                    <button
                      onClick={() => handleBookmark(course[currentIndex])}
                ...
                <div className="mx-auto px-5 bg-gray-100 shadow-3xl border rounded-2xl">
                  ...
                  {showScore ? (
                    <div className="text-center py-20">
                      ...
                      <button
                        className=" p-3 mt-5 text-white rounded-md items-center bg-blue-800"
                        type="submit"
                        onClick={restQuiz}
                      >
                        Try Againe
                    ...
                    <div className="p-4 w-5/6 mx-auto">
                      <div className="py-10">
                        ...
                        <div className="grid gap-4">
                          {Questionbank[currentQuestion].AnswersText?.map(
                            (answer) => (
                              <h1
                                className="py-4 rounded-md px-4 text-gray-600 bg-gray-200 hover:bg-green-600 hover:text-white ease-in-out duration-200"
                                onClick={() => handelOnclick(answer.isCorrect)}
                              >
                                {answer.Answers}
                              </h1>
                            )
            ...
            <div className="pb-4 pt-14 px-2 block md:flex justify-between items-center">
              ...
              <div className="space-x-4">
                <button
                  onClick={() => {
                    setQuestion(false);
                    videoChangeHandler("decrease");
                  }}
                  className="py-2 px-6 md:px-10 border-blue-600 border-2 rounded-full hover:bg-blue-600 hover:text-white ease-out duration-300 mt-4"
                >
                  Previous
                </button>
                {!question && (
                  <>
                    <button
                      ...
                      className="py-2 px-6 md:px-10 border-blue-600 border-2 rounded-full bg-blue-600 text-white mt-4"
                    >
                      Next
                    </button>
                  </>
            ...
            <div>
              ...
              <div className="course-content-list rounded-lg ">
                ...
                <button
                  ...
                  className="py-3 bg-blue-500 w-full rounded-md text-white"
                >
                  {" "}
                  Question test
                </button>
