            ...
            <div class="max-w-4xl  mx-auto bg-white overflow-hidden ">
                <div class="md:flex justify-center">
                    ...
                    <div class="p-8">
                        ...
                        <p class="mt-2 mb-2 text-slate-500">Helping employees gain skills and providing career development often take a back seat to business priorities but workplace.</p>
                        ...
                        <div>
                            <form class="mt-2 flex">
                                ...
                                <button class="px-8 rounded-r-lg bg-indigo-500  font-bold p-4 uppercase border-indigo-500 border-t border-b border-r">Subscribe</button>
                            </form>
                        </div>
                    </div>
                </div>
