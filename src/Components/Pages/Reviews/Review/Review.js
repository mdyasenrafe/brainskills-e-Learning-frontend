            ...
            <header className='flex justify-between'>
                <span className='flex space-x-4'>
                    ...
                    <span className='text-left'>
                        <h2 className='text-lg font-semibold'>Richard Joseph</h2>
                        <h5 className='text-base text-gray-500'>Student</h5>
                    </span>
                </span>
                <img src="./quotes.png" alt="" />
            </header>
            <h1 className='text-blue-700 font-semibold text-xl py-5'>Helpful Instructors <span>!</span></h1>
